...
public class CompanyCeoDTO implements Serializable {
	...
	public String toString() {
		return "CompanyCeoDTO [name=" + name + ", company=" + company + ", age=" + age + ", country=" + country
				+ ", qualification=" + qualification + ", married=" + married + ", dughter=" + dughter + "]";
	}
	...
	public void setDughter(DaughterDTO dughter) {
		this.dughter = dughter;
	}
